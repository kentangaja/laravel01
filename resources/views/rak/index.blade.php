                ...
                <div class="penulis p-0 m-0">
                    ...
                    <a href="{{ route('rak.create') }}">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('rak.destroy', $r->id) }}" method="POST" onsubmit="return confirm('Yakin mau hapus?')">
                                        @csrf
                                        @method('DELETE')
                        ...
                        <div class="flex justify-between mt-4">
                            @if ($allRak->onFirstPage())
                                <span class="text-gray-400">← Sebelumnya</span>
                            @else
                                <a href="{{ $allRak->previousPageUrl() }}" class="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600">
                                    ← Sebelumnya
                                </a>
                            @endif
                        |
                            @if ($allRak->hasMorePages())
                                <a href="{{ $allRak->nextPageUrl() }}" class="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600">
                                    Selanjutnya →
                                </a>
                            @else
