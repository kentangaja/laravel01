<!-- sidebar -->
<nav class="flex-column w-100vh d-flex" id="sidebar">
    <ul class="p-0 m-0 justify-content-center" style="list-style-type: none;">
        <li class="d-flex" >
            <span style="font-weight: 600;">ADMIN</span>
            <button onclick="toggleSidebar()" id="toggle-btn" class="btn btn-dark " style="margin-left: auto; margin-bottom: 7px; padding-bottom: 3px; background: none; padding-left: 1.5em; padding-right: 0; border: none;">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#3C3D37" class="bi bi-list" viewBox="0 0 16 16">
        ...
        <li class="d-flex">
            <a class="nav-link" href="/settingAdmin">
